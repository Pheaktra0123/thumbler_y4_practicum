...
@section('contents')
                        ...
                        <div class="flex items-center mt-2">
                            ...
                            <div class="flex items-center space-x-1">
                                @for ($i = 0; $i < $fullStars; $i++)
                                    <svg class="w-5 h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20"><polygon points="9.9,1.1 7.6,6.6 1.6,7.6 6,11.9 4.8,17.8 9.9,14.9 15,17.8 13.8,11.9 18.2,7.6 12.2,6.6 "/></svg>
                                @endfor
                                @if ($halfStar)
                                ...
                                @for ($i = 0; $i < $emptyStars; $i++)
                                    <svg class="w-5 h-5 text-gray-300" fill="currentColor" viewBox="0 0 20 20"><polygon points="9.9,1.1 7.6,6.6 1.6,7.6 6,11.9 4.8,17.8 9.9,14.9 15,17.8 13.8,11.9 18.2,7.6 12.2,6.6 "/></svg>
                                @endfor
                            </div>
    ...
    @if(auth()->check())
        <form id="ratingForm" action="{{ route('tumbler.rate', $tumbler->id) }}" method="POST" class="my-8 bg-white rounded-lg shadow p-6 max-w-md mx-auto">
            @csrf
