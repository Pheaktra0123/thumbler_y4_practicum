        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row -mx-4">
                <div class="md:flex-1 px-4">
                    <div
                        class="h-[480px] flex items-center justify-center rounded-lg bg-gray-200 dark:bg-gray-700 mb-4">
                ...
                <div class="md:flex-1 px-4">
                    ...
                    <p id="price" class="text-black dark:text-white font-bold text-2xl mt-2">$55.00</p>

                    <div class="flex items-center mb-4 mt-5">
                        <span class="mt-2 px-2 py-1 text-gray-700 dark:text-gray-300">Qty</span>
                        <button id="decrement"
                            class="border w-8 h-8 flex items-center justify-center rounded-full bg-black text-white text-sm">-</button>
                        <span id="quantity" class="mx-7 text-gray-700 dark:text-gray-300">1</span>
                        <button id="increment"
                            class="border w-8 h-8 flex items-center justify-center rounded-full bg-black text-white text-sm">+</button>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <button class="color-btn w-6 h-6 rounded-full bg-gray-800 dark:bg-gray-200 mr-2"
                            data-color="gray"></button>
                        <button class="color-btn w-6 h-6 rounded-full bg-red-500 dark:bg-gray-200 mr-2"
                            data-color="red"></button>
                        <button class="color-btn w-6 h-6 rounded-full bg-blue-500 dark:bg-gray-200 mr-2"
                            data-color="blue"></button>
                        <button class="color-btn w-6 h-6 rounded-full bg-pink-500 dark:bg-gray-200 mr-2"
                            data-color="pink"></button>
                        <button class="color-btn w-6 h-6 rounded-full bg-black dark:bg-gray-200 mr-2"
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        colorButtons.forEach(button => {
            button.addEventListener("click", function () {
                colorButtons.forEach(btn => btn.classList.remove("border-4", "border-black"));
