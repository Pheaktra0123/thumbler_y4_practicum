        ...
        <div class="relative w-full h-[600px] object-cover" id="home">
            ...
            <div class="absolute inset-9 flex flex-col md:flex-row items-center justify-center">
                <div class="md:w-1/2 mb-4 md:mb-0 text-center">
                    ...
                    <label
                        class="mx-auto relative min-w-sm max-w-2xl flex flex-col md:flex-row items-center justify-center  py-4 px-2 rounded-md gap-2  "
                        for="search-bar">
                        <form action="{{ route('search.categories') }}" method="GET" class="w-full">
                            <div class="relative flex items-center  rounded-md shadow-lg">
                                <input id="search-bar"
                                    type="search"
                                    name="query"
                                    value="{{ request('query') }}"
                                    placeholder="Search by name Tumbler"
                                    class="w-full py-5 px-6 text-gray-700 rounded-l-md">
                                <button id="search-button"
                                    class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-5 px-6 rounded-r-md transition-all">
                                    Search
                                </button>
                            </div>
                        </form>
