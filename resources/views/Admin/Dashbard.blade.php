    ...
    <div class="container mx-auto ">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
            <div class="bg-white rounded-lg shadow-md p-8">
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 text-sky-900 ">
            ...
            <div class="bg-white rounded-lg shadow-md p-8">
                <div>
                    ...
                    <h2 class="text-xl font-bold text-gray-600 mb-4">Orders</h2>
                </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-8">
                <div>
                    ...
                    <h2 class="text-xl font-bold text-gray-600 mb-4">Payments</h2>
                </div>
            </div>
        </div>
    </div>
...
<div class="flex justify-center w-full">
    ...
    <div class="w-[30%] bg-white p-5 mr-5 rounded-md shadow-xl">
        <div>
            <h2 class="text-xl text-gray-800 font-bold leading-tight">Product Sales</h2>
        </div>
        <canvas id="donut-chart" class="p-5"></canvas>
    </div>
</div>
</body>
<script>
