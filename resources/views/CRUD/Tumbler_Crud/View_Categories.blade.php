    ...
    <main>
        <section class="mb-10">
            <div class="flex gap-2 mt-5 mx-5 justify-between">
                <h1 class="text-3xl font-bold text-gray-700 uppercase">Categories</h1>
            </div>
            <div class="flex justify-between item-center place-content-center px-10">
                ...
                <button data-modal-target="crud-modal" data-modal-toggle="crud-modal" class="flex place-items-center gap-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-1 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
                    Add
