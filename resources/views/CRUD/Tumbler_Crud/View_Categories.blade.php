...
<body>
    <main>
        ...
        <section>
            <div class="flex flex-col bg-white shadow-sm rounded-lg w-11/12 mx-auto">
                            ...
                            <table class=" min-w-full rounded-xl">
                                <thead>
                                    <tr class="bg-gray-50">
                                        ...
                                        <th scope="col" class="p-5 text-left text-sm leading-6 font-semibold text-gray-900 capitalize"> Thumbnail</th>
