...
<body>
    <main>
        <section class="">
            <h1 class="text-5xl font-bold text-gray-800 text-center mt-2 uppercase">Model</h1>
            <div class="flex justify-evenly items-center mt-5 mx-5">
                <p class="text-lg content-center font-bold">All</p>
                <div class="flex w-">
                    <form action="{{ route('Admin/Model') }}" method="GET">
                        <input
                            ...
                            placeholder="Search model tumbler ">
                        <button
                            type="submit"
                ...
                <button data-modal-target="crud-modal" data-modal-toggle="crud-modal" class="flex item-content-center content-item-center bg-blue-700 text-white px-4 py-3 rounded-lg " type="button">
                    Model
            ...
            <div id="crud-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                <div class="relative p-4 w-full max-w-md max-h-full">
                    ...
                    <div class="relative bg-white rounded-lg shadow-sm ">
                        ...
                        <!-- Modal body -->
                        <form class="p-4 md:p-5" action="{{ route('Model.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <tbody class="divide-y divide-gray-300 ">
                                    ...
                                    <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                        ...
                                        <td class=" p-2 ">
                                            ...
                                            <div id="edit-modal{{$model->id}}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                                <div class="relative p-4 w-full max-w-md max-h-full">
                                                    <!-- Modal content -->
                                                    <div class="relative bg-white rounded-lg shadow">
                                                        ...
                                                        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                                                            ...
                                                            <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center" data-modal-toggle="edit-modal{{$model->id}}">
                                                                <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                                                                </svg>
                                                                <span class="sr-only">Close modal</span>
                                                        ...
                                                        <!-- Modal body -->
                                                        <form class="p-4 md:p-5" method="POST" action="{{ route('model.update', $model->id) }}" enctype="multipart/form-data">
                                                            @csrf
                                                            ...
                                                            <div class="grid gap-4 mb-4 grid-cols-2">
                                                                ...
                                                                <div class="col-span-2">
                                                                    ...
                                                                    <div class="w-[370px] relative border-2 border-gray-300 border-dashed rounded-lg p-6" id="dropzone">
                                                                        <input type="file" name="thumbnail" class="absolute inset-0 w-full h-full opacity-0 z-50" id="file-upload">
                                                                        <div class="text-center">
                                                                            <img class="mx-auto h-24 w-24" src="{{ Storage::url($model->Thumbnail) }}" alt="Current Thumbnail">
                                                                            <h3 class="mt-2 text-sm font-medium text-gray-900">
                                                                                <label for="file-upload" class="relative cursor-pointer">
                                                                                    <span>Drag and drop</span>
                                                                                    <span class="text-indigo-600"> or browse</span>
    ...
    <div id="deleteConfirmModal" class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white rounded-lg shadow-lg p-8 max-w-sm w-full text-center">
            ...
            <p class="mb-6 text-gray-600">Are you sure you want to delete this model?</p>
