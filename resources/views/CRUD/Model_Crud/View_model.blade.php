    ...
    <main>
        <section class="mb-10">
            ...
            <div class="flex justify-between item-center place-content-center px-10">
                ...
                <button data-modal-target="crud-modal" data-modal-toggle="crud-modal" class="flex place-items-center gap-2 text-white bg-blue-500 hover:bg-blue-800  focus:outline-none focus:ring-blue-300 font-medium rounded-2xl text-md px-3 text-center" type="button">
                    Model
                            ...
                            <table class=" min-w-full rounded-xl">
                                <thead>
                                    <tr class="bg-gray-50">
                                        ...
                                        <th scope="col" class="p-5 text-left text-sm leading-6 font-semibold text-gray-900 capitalize">Model Name</th>
                                        ...
                                        <th scope="col" class="p-5 text-left text-sm leading-6 font-semibold text-gray-900 capitalize"> Total Item</th>
                                ...
                                <tbody class="divide-y divide-gray-300 ">
                                    ...
                                    <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                        <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 ">{{$model->id}}</td>
                                        <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> {{$model->name}}</td>
                                        <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">{{$model->category->name}}</td>
                                        ...
                                        <td class=" p-5 ">
                                            <div class="flex items-center gap-1">
                                                ...
                                                <a href="/Admin/model/delete/{{$model->id}}">
