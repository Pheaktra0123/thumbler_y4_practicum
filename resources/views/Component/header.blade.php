...
<body class="bg-gray-100">
    <nav class="fixed top-0 left-0 right-0 z-50 bg-white/60 bg-opacity-90 backdrop-blur-md">
            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="hidden md:block uppercase">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="#" class="text-sm font-medium text-gray-900 hover:text-gray-600 px-3 py-2 rounded-md transition-colors duration-300">About Us</a>
                    </div>
                </div>
        ...
        <div id="menu" class="md:hidden hidden">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                ...
                <a href="#" class="text-sm block font-medium text-gray-900 hover:text-gray-600 px-3 py-2 rounded-md transition-colors duration-300">About Us</a>
            </div>
